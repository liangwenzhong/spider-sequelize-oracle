 ...
 * @param {Object}                  [options.alter] Let sequelize add the new colunms that the table doesn't exist.
 *
 * @return {Model}
 */
let b = false;
Sequelize.prototype.define = function (modelName, attributes, options) {
    ...
    if (this.options.define.alter) {
        // if model's attributes different from the datebase's, alter table add attributes
        AlterUtil(modelName, attributes, options);
    }
